...
export default function WaterMap({ localities, selectedId, onSelect, viewMode = 'markers', showWards = false }) {
  return (
    <MapContainer
      center={PUNE_CENTER}
      zoom={11}
    ...
    >
      ...
      />
      {showWards && <WardBoundaries />}
      {viewMode === 'heatmap' ? (
        <WaterHeatmap localities={localities} />
      ) : (
        localities.map((loc) => {
